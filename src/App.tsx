                      ...
                      <div className="space-y-4">
                        ...
                        <div className="pt-2 flex flex-wrap gap-2">
                          ...
                          <button
                            ...
                            disabled={syncingStatus === 'syncing' || !appsScriptUrl.trim()}
                            className={`text-xs px-4 py-2.5 rounded-xl font-bold transition flex items-center gap-1.5 cursor-pointer shadow-xs select-none ${
                              !appsScriptUrl.trim() 
                                ? 'bg-gray-100 text-gray-400 cursor-not-allowed' 
                        ...
                        <div className="border border-slate-100 rounded-xl p-3 bg-slate-50/50 space-y-2 text-xs">
                          <div className="flex justify-between items-center">
                            ...
                            <button
                              ...
                              className="text-xs text-[#2491bf] font-bold hover:underline cursor-pointer select-none"
                            >
                            ...
                            <div className="pt-2 border-t border-slate-200/50 space-y-3.5">
                              ...
                              <div className="flex justify-between items-center">
                                ...
                                <button
                                  ...
                                  className={`px-3 py-1.5 text-xs font-extrabold rounded-lg transition-colors duration-155 flex items-center gap-1 select-none cursor-pointer ${
                                    scriptCopied 
